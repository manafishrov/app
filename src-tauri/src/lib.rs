...
use commands::{
  ...
  gamepad_vibrate, get_config, manual_rollback_firmware, request_rov_config, save_recording,
  ...
  toggle_auto_stabilization, toggle_depth_hold, upload_firmware_update,
};
