...
const AppConnectionFields: Component<{ AppField: AppConnectionFieldRenderer }> = (props) => (
  <>
    ...
    <props.AppField name='webrtcSignalingApiPort'>
      {(field) => (
    ...
    <props.AppField name='webrtcSignalingApiPath'>
      {(field) => (
        <field.TextInputField
...
export const AppConnection: Component = () => {
  ...
  return (
    <form.AppForm>
      <form.Form>
        <AppConnectionFields AppField={form.AppField} />
