...
function SidebarProvider({
  ...
  const contextValue = useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, collapseOnMobile],
  );
...
function Sidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile, collapseOnMobile } = useSidebar();
...
function SidebarMenuButton({
  ...
  const Comp = asChild ? Slot : 'button';
  const { isMobile, state, collapseOnMobile } = useSidebar();
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side='right'
        align='center'
        hidden={state !== 'collapsed' || (isMobile && !collapseOnMobile)}
        {...tooltip}
      />
    </Tooltip>
  );
